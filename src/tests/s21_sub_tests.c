...
START_TEST(s21_sub_1) {
  s21_decimal resutl;
  s21_decimal first =  {{0b01111111111111111111111111000001, 0b11111111111111111111111111000001, 0b11111111111111111111111111000001,  0b00000000000000000000000000000000}};
  s21_decimal second = {{0b11111111111111111111000000000011, 0b11111111111111111111111111000000, 0b11111111111111111111111111000001, 0b00000000000000000000000000000000}};
...
START_TEST(s21_sub_2) {
  s21_decimal resutl;
  s21_decimal first =  {{0b00000000000000000000000000000000, 0, 0b10000000000000000000000000000000,  0b00000000000000000000000000000000}};
...
START_TEST(s21_sub_3) {
  s21_decimal resutl;
  s21_decimal first =  {{0b00000000000000000000000010000000, 0, 0b00000000000000000000000000000000,  0b00000000000000000000000000000000}};
...
START_TEST(s21_sub_4) {
  s21_decimal resutl;
  s21_decimal first =  {{0b00000000000000000001111110000000, 0, 0b00000000000000000000000000000000,  0b00000000001011000000000000000000}};
